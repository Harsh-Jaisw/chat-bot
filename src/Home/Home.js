...
function Home() {
  ...
  const localId=   JSON.parse(localStorage.getItem("orderDetails"))
          ...
          <div className={style.home}>
            ...
            {isInput && (
              ...
              {showOrder ? localId.status :
                ...
                />}
                <button onClick={handleOrder}> Check order</button>
              </>
            )}
          </div>
        }
